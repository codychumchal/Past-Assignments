...
#include "sequence.h"
using namespace std;
using namespace CS3358_FA15_A04;
...
void show_list(seqItem<double> src);
// Pre: (none)
// Post: The items of src are printed to cout (one per line).
void show_list(seqItem<char>  src);
// Pre: (none)
// Post: The items of src are printed to cout (one per line).
int get_object_num();
// Pre:  (none)
...
{
   seqItem<double> s1;     // A sequence of double for testing
   seqItem<char> s2;       // A sequence of char for testing
